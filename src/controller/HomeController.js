...
let writeDataToGGSheet = async (data) => {
...
let postReserveTable = async (req, res) => {
  ...
  try {
    let userName = await chatborService.getUserName(req.body.psid)
    let data = {
      userName: userName,
    ...
    await writeDataToGGSheet(data)

    let customerName = ""
    if (req.body.customerName === "") {
      customerName = await chatborService.getUserName(req.body.psid)
    } else {
      customerName = req.body.customerName
    }
